function plaintext_str = aes_decrypt(key_input, ciphertext_with_iv)
    ...
    % Extract the 12-byte IV and the actual ciphertext
    iv = int8(ciphertext_with_iv(1:12));
    ciphertext = int8(ciphertext_with_iv(13:end));
    ...
    endfunction plaintext_str = aes_decrypt(key_input, ciphertext_with_iv)
    % =====================================================================
    % SwarmAuth: AES-GCM Decryption & Tag Verification
    % Extracts the IV, parses Hex keys, and validates MITM tampering.
    % =====================================================================
